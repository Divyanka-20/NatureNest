...
<html>
    <head>
        ...
        <title>Add reserve forests</title>
    </head>
    <body>
        <h1 align="center">Reserve Forest</h1>
        <form method="post">
        <table align="center">
            <tr>
                <td>
                    <input type="text" id="nm" name="nm" placeholder="Enter the Reserve Forest Name" required />
                </td>
            </tr>
            <tr>
                <td>
        ...
        <%
            ...
            String ins="insert into reserveforest(name,state,area,animals) values(?,?,?,?)";
