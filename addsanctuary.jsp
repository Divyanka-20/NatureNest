...
<html>
    ...
    <body>
        ...
        <table align="center">
            <tr>
                <td>
                    <input type="text" id="nm" name="nm" placeholder="Enter the Sanctuary Name" required />
                </td>
            </tr>
            <tr>
                <td>
        ...
        <%
            ...
            String ins="insert into sanctuary(name,state,area,animals) values(?,?,?,?)";
